...
EMSCRIPTEN_BINDINGS(trueform_topology_make_domain_labels_float64) {
  using Real = double;
  using namespace tf::ts;

  emscripten::value_object<domain_labels_result_t<Real>>(
      "DomainLabelsResultFloat64")
  ...
  emscripten::function("make_domain_labels_float64",
                       &sync_make_domain_labels<Real>);
  emscripten::function("dispatch_make_domain_labels_float64",
