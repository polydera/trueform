...
EMSCRIPTEN_BINDINGS(trueform_geometry_quality_float64) {
  using Real = double;
  using namespace tf::ts;

  emscripten::value_object<face_quality_result_t<Real>>(
      "FaceQualityResultFloat64")
  ...
  emscripten::value_object<dihedral_angles_result_t<Real>>(
      "DihedralAnglesResultFloat64")
      .field("edges", &dihedral_angles_result_t<Real>::edges)
      .field("angles", &dihedral_angles_result_t<Real>::angles);

  emscripten::function("face_quality_float64", &sync_face_quality<Real>);
  emscripten::function("dispatch_face_quality_float64",
                       &async_face_quality<Real>);
  emscripten::function("dihedral_angles_float64", &sync_dihedral_angles<Real>);
  emscripten::function("dispatch_dihedral_angles_float64",
