...
EMSCRIPTEN_BINDINGS(trueform_cut_isobands_float32) {
  ...
  // Result types
  emscripten::value_object<isobands_result_t<Real>>("IsobandsResultFloat32")
  ...
  emscripten::value_object<isobands_result_with_curves_t<Real>>(
      "IsobandsResultWithCurvesFloat32")
  ...
  // Sync
  emscripten::function("isobands_float32", &sync_isobands<Real>);
  emscripten::function("isobands_with_curves_float32",
                       &sync_isobands_with_curves<Real>);
  emscripten::function("isobands_selected_float32",
                       &sync_isobands_selected<Real>);
  emscripten::function("isobands_with_curves_selected_float32",
                       &sync_isobands_with_curves_selected<Real>);

  // Async
  emscripten::function("dispatch_isobands_float32", &async_isobands<Real>);
  emscripten::function("dispatch_isobands_with_curves_float32",
                       &async_isobands_with_curves<Real>);
  emscripten::function("dispatch_isobands_selected_float32",
                       &async_isobands_selected<Real>);
  emscripten::function("dispatch_isobands_with_curves_selected_float32",
