...
EMSCRIPTEN_BINDINGS(trueform_csg_graph_float64) {
  using Real = double;
  using namespace tf::ts;

  emscripten::class_<wasm_csg_graph<Real>>("CsgGraphFloat64")
      .constructor<>()
      .function("isValid", &wasm_csg_graph<Real>::is_valid)
      .function("destroy", &wasm_csg_graph<Real>::destroy);

  emscripten::value_object<csg_mesh_labeled_t<Real>>("CsgMeshLabeledFloat64")
  ...
  // Sync
  emscripten::function("csg_graph_float64", &sync_csg_graph<Real>);
  emscripten::function("csg_mesh_float64", &sync_csg_mesh<Real>);
  emscripten::function("csg_mesh_with_labels_float64",
                       &sync_csg_mesh_with_labels<Real>);
  emscripten::function("csg_mesh_with_index_map_float64",
                       &sync_csg_mesh_with_index_map<Real>);
  emscripten::function("csg_domains_float64", &sync_csg_domains<Real>);
  emscripten::function("csg_domains_with_labels_float64",
                       &sync_csg_domains_with_labels<Real>);
  emscripten::function("csg_domains_with_index_map_float64",
                       &sync_csg_domains_with_index_map<Real>);
  emscripten::function("csg_created_points_float64",
                       &sync_csg_created_points<Real>);
  emscripten::function("csg_intersection_curves_float64",
                       &sync_csg_intersection_curves<Real>);

  // Async
  emscripten::function("dispatch_csg_graph_float64", &async_csg_graph<Real>);
  emscripten::function("dispatch_csg_intersection_curves_float64",
                       &async_csg_intersection_curves<Real>);
  emscripten::function("dispatch_csg_mesh_float64", &async_csg_mesh<Real>);
  emscripten::function("dispatch_csg_mesh_with_labels_float64",
                       &async_csg_mesh_with_labels<Real>);
  emscripten::function("dispatch_csg_mesh_with_index_map_float64",
                       &async_csg_mesh_with_index_map<Real>);
  emscripten::function("dispatch_csg_domains_float64",
                       &async_csg_domains<Real>);
  emscripten::function("dispatch_csg_domains_with_labels_float64",
                       &async_csg_domains_with_labels<Real>);
  emscripten::function("dispatch_csg_domains_with_index_map_float64",
