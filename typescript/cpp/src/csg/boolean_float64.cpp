...
EMSCRIPTEN_BINDINGS(trueform_csg_boolean_float64) {
  using Real = double;
  using namespace tf::ts;

  // Result types
  emscripten::value_object<labeled_boolean_result_t<Real>>(
      "LabeledBooleanResultFloat64")
  ...
  emscripten::value_object<labeled_boolean_result_with_curves_t<Real>>(
      "LabeledBooleanResultWithCurvesFloat64")
  ...
  // Sync
  emscripten::function("boolean_union_float64", &sync_boolean_union<Real>);
  emscripten::function("boolean_intersection_float64",
                       &sync_boolean_intersection<Real>);
  emscripten::function("boolean_difference_float64",
                       &sync_boolean_difference<Real>);
  emscripten::function("boolean_union_with_curves_float64",
                       &sync_boolean_union_with_curves<Real>);
  emscripten::function("boolean_intersection_with_curves_float64",
                       &sync_boolean_intersection_with_curves<Real>);
  emscripten::function("boolean_difference_with_curves_float64",
                       &sync_boolean_difference_with_curves<Real>);

  // Async
  emscripten::function("dispatch_boolean_union_float64",
                       &async_boolean_union<Real>);
  emscripten::function("dispatch_boolean_intersection_float64",
                       &async_boolean_intersection<Real>);
  emscripten::function("dispatch_boolean_difference_float64",
                       &async_boolean_difference<Real>);
  emscripten::function("dispatch_boolean_union_with_curves_float64",
                       &async_boolean_union_with_curves<Real>);
  emscripten::function("dispatch_boolean_intersection_with_curves_float64",
                       &async_boolean_intersection_with_curves<Real>);
  emscripten::function("dispatch_boolean_difference_with_curves_float64",
