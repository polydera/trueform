...
EMSCRIPTEN_BINDINGS(trueform_arrangement_mesh_arrangement_float32) {
  using Real = float;
  using namespace tf::ts;

  // Result types
  emscripten::value_object<arrangement_result_t<Real>>(
      "MeshArrangementResultFloat32")
  ...
  emscripten::value_object<arrangement_result_with_curves_t<Real>>(
      "MeshArrangementResultWithCurvesFloat32")
  ...
  // Sync
  emscripten::function("mesh_arrangements_float32",
                       &sync_mesh_arrangement<Real>);
  emscripten::function("mesh_arrangements_with_curves_float32",
                       &sync_mesh_arrangement_with_curves<Real>);

  // Async
  emscripten::function("dispatch_mesh_arrangements_float32",
                       &async_mesh_arrangement<Real>);
  emscripten::function("dispatch_mesh_arrangements_with_curves_float32",
