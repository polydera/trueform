...
EMSCRIPTEN_BINDINGS(trueform_arrangement_polygon_arrangement_float64) {
  using Real = double;
  using namespace tf::ts;

  // Result types
  emscripten::value_object<polygon_arrangement_result_t<Real>>(
      "PolygonArrangementResultFloat64")
  ...
  emscripten::value_object<polygon_arrangement_result_with_curves_t<Real>>(
      "PolygonArrangementResultWithCurvesFloat64")
  ...
  // Sync
  emscripten::function("polygon_arrangements_float64",
                       &sync_polygon_arrangements<Real>);
  emscripten::function("polygon_arrangements_with_curves_float64",
                       &sync_polygon_arrangements_with_curves<Real>);

  // Async
  emscripten::function("dispatch_polygon_arrangements_float64",
                       &async_polygon_arrangements<Real>);
  emscripten::function("dispatch_polygon_arrangements_with_curves_float64",
