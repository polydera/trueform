...
#include <trueform/geometry/fit_similarity_alignment.hpp>
...
auto fit_similarity_alignment_impl(point_cloud_wrapper<RealT, Dims> &cloud0,
  ...
  auto compute = [&]() {
    if (has0 && has1) {
      return tf::fit_similarity_alignment(
      ...
      return tf::fit_similarity_alignment(pts0, pts1);
    }
  };
