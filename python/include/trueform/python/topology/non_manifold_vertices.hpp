...
#include <trueform/topology/non_manifold_vertices.hpp>

namespace tf::py {
template <typename Index, std::size_t Ngon>
auto non_manifold_vertices(
  ...
  return make_numpy_array(tf::make_non_manifold_vertices(faces, fml));
}

template <typename Index>
auto non_manifold_vertices_dynamic(
