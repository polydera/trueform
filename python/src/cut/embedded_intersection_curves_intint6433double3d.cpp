...
auto register_embedded_intersection_curves_intint6433double3d(nanobind::module_ &m) -> void {
  ...
  m.def("embedded_intersection_curves_mesh_mesh_intint6433double3d",
        [](mesh_wrapper<int, double, 3, 3> &mesh0,
           mesh_wrapper<std::int64_t, double, 3, 3> &mesh1, int mode, double tolerance) {
          return embedded_intersection_curves(mesh0, mesh1, mode, tolerance);
        },
        nanobind::arg("mesh0"), nanobind::arg("mesh1"), nanobind::arg("mode"), nanobind::arg("tolerance") = 0.0);

  // 3×3 with curves
  m.def("embedded_intersection_curves_curves_mesh_mesh_intint6433double3d",
        [](mesh_wrapper<int, double, 3, 3> &mesh0,
           mesh_wrapper<std::int64_t, double, 3, 3> &mesh1, int mode, double tolerance) {
          return embedded_intersection_curves(mesh0, mesh1, mode, tolerance, tf::return_curves);
        },
        nanobind::arg("mesh0"), nanobind::arg("mesh1"), nanobind::arg("mode"), nanobind::arg("tolerance") = 0.0);
  ...
  m.def("embedded_intersection_curves_mesh_mesh_intint643dyndouble3d",
        [](mesh_wrapper<int, double, 3, 3> &mesh0,
           mesh_wrapper<std::int64_t, double, dynamic_size, 3> &mesh1, int mode, double tolerance) {
          return embedded_intersection_curves(mesh0, mesh1, mode, tolerance);
        },
        nanobind::arg("mesh0"), nanobind::arg("mesh1"), nanobind::arg("mode"), nanobind::arg("tolerance") = 0.0);
