...
auto register_clean_cleaned(nanobind::module_ &m) -> void {
  ...
  m.def(
      ...
      [](ndarray<numpy, const float, shape<-1, 2>> points,
        ...
        return cleaned_impl<int64_t, float, 2>(points, tolerance, remove_duplicate_primitives,
                                               remove_unreferenced_points, tf::return_index_map);
      },
      arg("points"), arg("tolerance").none() = nanobind::none(),
      arg("remove_duplicate_primitives") = true,
      arg("remove_unreferenced_points") = true);
  ...
  m.def(
      ...
      [](ndarray<numpy, const double, shape<-1, 2>> points,
         ...
         bool remove_duplicate_primitives,
         bool remove_unreferenced_points) {
        return cleaned_impl<int64_t, double, 2>(points, tolerance, remove_duplicate_primitives,
                                                remove_unreferenced_points, tf::return_index_map);
      },
      arg("points"), arg("tolerance").none() = nanobind::none(),
      arg("remove_duplicate_primitives") = true,
  ...
  m.def(
      ...
      [](ndarray<numpy, const float, shape<-1, 3>> points,
         ...
         bool remove_duplicate_primitives,
         bool remove_unreferenced_points) {
        return cleaned_impl<int64_t, float, 3>(points, tolerance, remove_duplicate_primitives,
                                               remove_unreferenced_points, tf::return_index_map);
      },
      arg("points"), arg("tolerance").none() = nanobind::none(),
      arg("remove_duplicate_primitives") = true,
  ...
  m.def(
      ...
      [](ndarray<numpy, const double, shape<-1, 3>> points,
         ...
         bool remove_duplicate_primitives,
         bool remove_unreferenced_points) {
        return cleaned_impl<int64_t, double, 3>(points, tolerance, remove_duplicate_primitives,
                                                remove_unreferenced_points, tf::return_index_map);
      },
      arg("points"), arg("tolerance").none() = nanobind::none(),
      arg("remove_duplicate_primitives") = true,
  ...
  m.def(
      ...
      [](ndarray<numpy, const float, shape<-1, 2, 2>> soup,
         ...
         bool remove_duplicate_primitives,
         bool remove_unreferenced_points) {
        return cleaned_impl<int, float, 2, 2>(soup, tolerance, remove_duplicate_primitives, remove_unreferenced_points);
      },
  ...
  m.def(
      ...
      [](ndarray<numpy, const double, shape<-1, 2, 2>> soup,
         ...
         bool remove_duplicate_primitives,
         bool remove_unreferenced_points) {
        return cleaned_impl<int, double, 2, 2>(soup, tolerance, remove_duplicate_primitives, remove_unreferenced_points);
      },
      arg("soup"), arg("tolerance").none() = nanobind::none(),
      arg("remove_duplicate_primitives") = true,
      arg("remove_unreferenced_points") = true);
  ...
  m.def(
      ...
      [](ndarray<numpy, const float, shape<-1, 2, 3>> soup,
         ...
         bool remove_duplicate_primitives,
         bool remove_unreferenced_points) {
        return cleaned_impl<int, float, 2, 3>(soup, tolerance, remove_duplicate_primitives, remove_unreferenced_points);
      },
      arg("soup"), arg("tolerance").none() = nanobind::none(),
      arg("remove_duplicate_primitives") = true,
      arg("remove_unreferenced_points") = true);
  ...
  m.def(
      ...
      [](ndarray<numpy, const double, shape<-1, 2, 3>> soup,
         ...
         bool remove_duplicate_primitives,
         bool remove_unreferenced_points) {
        return cleaned_impl<int, double, 2, 3>(soup, tolerance, remove_duplicate_primitives, remove_unreferenced_points);
      },
      arg("soup"), arg("tolerance").none() = nanobind::none(),
      arg("remove_duplicate_primitives") = true,
      arg("remove_unreferenced_points") = true);
  ...
  m.def(
      ...
      [](ndarray<numpy, const float, shape<-1, 3, 2>> soup,
         ...
         bool remove_duplicate_primitives,
         bool remove_unreferenced_points) {
        return cleaned_impl<int, float, 3, 2>(soup, tolerance, remove_duplicate_primitives, remove_unreferenced_points);
      },
      arg("soup"), arg("tolerance").none() = nanobind::none(),
      arg("remove_duplicate_primitives") = true,
      arg("remove_unreferenced_points") = true);
  ...
  m.def(
      ...
      [](ndarray<numpy, const double, shape<-1, 3, 2>> soup,
         ...
         bool remove_duplicate_primitives,
         bool remove_unreferenced_points) {
        return cleaned_impl<int, double, 3, 2>(soup, tolerance, remove_duplicate_primitives, remove_unreferenced_points);
      },
      arg("soup"), arg("tolerance").none() = nanobind::none(),
      arg("remove_duplicate_primitives") = true,
      arg("remove_unreferenced_points") = true);
  ...
  m.def(
      ...
      [](ndarray<numpy, const float, shape<-1, 3, 3>> soup,
         ...
         bool remove_duplicate_primitives,
         bool remove_unreferenced_points) {
        return cleaned_impl<int, float, 3, 3>(soup, tolerance, remove_duplicate_primitives, remove_unreferenced_points);
      },
      arg("soup"), arg("tolerance").none() = nanobind::none(),
      arg("remove_duplicate_primitives") = true,
      arg("remove_unreferenced_points") = true);
  ...
  m.def(
      ...
      [](ndarray<numpy, const double, shape<-1, 3, 3>> soup,
         ...
         bool remove_duplicate_primitives,
         bool remove_unreferenced_points) {
        return cleaned_impl<int, double, 3, 3>(soup, tolerance, remove_duplicate_primitives, remove_unreferenced_points);
      },
      arg("soup"), arg("tolerance").none() = nanobind::none(),
      arg("remove_duplicate_primitives") = true,
      arg("remove_unreferenced_points") = true);
  ...
  m.def(
      ...
      [](ndarray<numpy, const int, shape<-1, 2>> indices,
         ...
         bool remove_duplicate_primitives,
         bool remove_unreferenced_points) {
        return cleaned_impl<int, 2, float, 2>(indices, points, tolerance, remove_duplicate_primitives,
                                              remove_unreferenced_points, tf::return_index_map);
      },
  ...
  m.def(
      ...
      [](ndarray<numpy, const int, shape<-1, 2>> indices,
         ...
         bool remove_duplicate_primitives,
         bool remove_unreferenced_points) {
        return cleaned_impl<int, 2, double, 2>(indices, points, tolerance, remove_duplicate_primitives,
                                               remove_unreferenced_points, tf::return_index_map);
      },
      arg("indices"), arg("points"), arg("tolerance").none() = nanobind::none(),
      arg("remove_duplicate_primitives") = true,
  ...
  m.def(
      ...
      [](ndarray<numpy, const int64_t, shape<-1, 2>> indices,
         ...
         bool remove_duplicate_primitives,
         bool remove_unreferenced_points) {
        return cleaned_impl<int64_t, 2, float, 2>(indices, points, tolerance, remove_duplicate_primitives,
                                                   remove_unreferenced_points, tf::return_index_map);
      },
      arg("indices"), arg("points"), arg("tolerance").none() = nanobind::none(),
      arg("remove_duplicate_primitives") = true,
  ...
  m.def(
      ...
      [](ndarray<numpy, const int64_t, shape<-1, 2>> indices,
         ...
         bool remove_duplicate_primitives,
         bool remove_unreferenced_points) {
        return cleaned_impl<int64_t, 2, double, 2>(indices, points, tolerance, remove_duplicate_primitives,
                                                    remove_unreferenced_points, tf::return_index_map);
      },
      arg("indices"), arg("points"), arg("tolerance").none() = nanobind::none(),
      arg("remove_duplicate_primitives") = true,
  ...
  m.def(
      ...
      [](ndarray<numpy, const int, shape<-1, 2>> indices,
         ...
         bool remove_duplicate_primitives,
         bool remove_unreferenced_points) {
        return cleaned_impl<int, 2, float, 3>(indices, points, tolerance, remove_duplicate_primitives,
                                              remove_unreferenced_points, tf::return_index_map);
      },
      arg("indices"), arg("points"), arg("tolerance").none() = nanobind::none(),
      arg("remove_duplicate_primitives") = true,
  ...
  m.def(
      ...
      [](ndarray<numpy, const int, shape<-1, 2>> indices,
         ...
         bool remove_duplicate_primitives,
         bool remove_unreferenced_points) {
        return cleaned_impl<int, 2, double, 3>(indices, points, tolerance, remove_duplicate_primitives,
                                               remove_unreferenced_points, tf::return_index_map);
      },
      arg("indices"), arg("points"), arg("tolerance").none() = nanobind::none(),
      arg("remove_duplicate_primitives") = true,
  ...
  m.def(
      ...
      [](ndarray<numpy, const int64_t, shape<-1, 2>> indices,
         ...
         bool remove_duplicate_primitives,
         bool remove_unreferenced_points) {
        return cleaned_impl<int64_t, 2, float, 3>(indices, points, tolerance, remove_duplicate_primitives,
                                                   remove_unreferenced_points, tf::return_index_map);
      },
      arg("indices"), arg("points"), arg("tolerance").none() = nanobind::none(),
      arg("remove_duplicate_primitives") = true,
  ...
  m.def(
      ...
      [](ndarray<numpy, const int64_t, shape<-1, 2>> indices,
         ...
         bool remove_duplicate_primitives,
         bool remove_unreferenced_points) {
        return cleaned_impl<int64_t, 2, double, 3>(indices, points, tolerance, remove_duplicate_primitives,
                                                    remove_unreferenced_points, tf::return_index_map);
      },
      arg("indices"), arg("points"), arg("tolerance").none() = nanobind::none(),
      arg("remove_duplicate_primitives") = true,
  ...
  m.def(
      ...
      [](ndarray<numpy, const int, shape<-1, 3>> indices,
         ...
         bool remove_duplicate_primitives,
         bool remove_unreferenced_points) {
        return cleaned_impl<int, 3, float, 2>(indices, points, tolerance, remove_duplicate_primitives,
                                              remove_unreferenced_points, tf::return_index_map);
      },
      arg("indices"), arg("points"), arg("tolerance").none() = nanobind::none(),
      arg("remove_duplicate_primitives") = true,
  ...
  m.def(
      ...
      [](ndarray<numpy, const int, shape<-1, 3>> indices,
         ...
         bool remove_duplicate_primitives,
         bool remove_unreferenced_points) {
        return cleaned_impl<int, 3, double, 2>(indices, points, tolerance, remove_duplicate_primitives,
                                               remove_unreferenced_points, tf::return_index_map);
      },
      arg("indices"), arg("points"), arg("tolerance").none() = nanobind::none(),
      arg("remove_duplicate_primitives") = true,
  ...
  m.def(
      ...
      [](ndarray<numpy, const int64_t, shape<-1, 3>> indices,
         ...
         bool remove_duplicate_primitives,
         bool remove_unreferenced_points) {
        return cleaned_impl<int64_t, 3, float, 2>(indices, points, tolerance, remove_duplicate_primitives,
                                                   remove_unreferenced_points, tf::return_index_map);
      },
      arg("indices"), arg("points"), arg("tolerance").none() = nanobind::none(),
      arg("remove_duplicate_primitives") = true,
  ...
  m.def(
      ...
      [](ndarray<numpy, const int64_t, shape<-1, 3>> indices,
         ...
         bool remove_duplicate_primitives,
         bool remove_unreferenced_points) {
        return cleaned_impl<int64_t, 3, double, 2>(indices, points, tolerance, remove_duplicate_primitives,
                                                    remove_unreferenced_points, tf::return_index_map);
      },
      arg("indices"), arg("points"), arg("tolerance").none() = nanobind::none(),
      arg("remove_duplicate_primitives") = true,
  ...
  m.def(
      ...
      [](ndarray<numpy, const int, shape<-1, 3>> indices,
         ...
         bool remove_duplicate_primitives,
         bool remove_unreferenced_points) {
        return cleaned_impl<int, 3, float, 3>(indices, points, tolerance, remove_duplicate_primitives,
                                              remove_unreferenced_points, tf::return_index_map);
      },
      arg("indices"), arg("points"), arg("tolerance").none() = nanobind::none(),
      arg("remove_duplicate_primitives") = true,
  ...
  m.def(
      ...
      [](ndarray<numpy, const int, shape<-1, 3>> indices,
         ...
         bool remove_duplicate_primitives,
         bool remove_unreferenced_points) {
        return cleaned_impl<int, 3, double, 3>(indices, points, tolerance, remove_duplicate_primitives,
                                               remove_unreferenced_points, tf::return_index_map);
      },
      arg("indices"), arg("points"), arg("tolerance").none() = nanobind::none(),
      arg("remove_duplicate_primitives") = true,
  ...
  m.def(
      ...
      [](ndarray<numpy, const int64_t, shape<-1, 3>> indices,
         ...
         bool remove_duplicate_primitives,
         bool remove_unreferenced_points) {
        return cleaned_impl<int64_t, 3, float, 3>(indices, points, tolerance, remove_duplicate_primitives,
                                                   remove_unreferenced_points, tf::return_index_map);
      },
      arg("indices"), arg("points"), arg("tolerance").none() = nanobind::none(),
      arg("remove_duplicate_primitives") = true,
  ...
  m.def(
      ...
      [](ndarray<numpy, const int64_t, shape<-1, 3>> indices,
         ...
         bool remove_duplicate_primitives,
         bool remove_unreferenced_points) {
        return cleaned_impl<int64_t, 3, double, 3>(indices, points, tolerance, remove_duplicate_primitives,
                                                    remove_unreferenced_points, tf::return_index_map);
      },
      arg("indices"), arg("points"), arg("tolerance").none() = nanobind::none(),
      arg("remove_duplicate_primitives") = true,
  ...
  m.def(
      ...
      [](const offset_blocked_array_wrapper<int, int> &indices,
         ...
         bool remove_duplicate_primitives,
         bool remove_unreferenced_points) {
        return cleaned_impl_dynamic<int, float, 2>(indices, points, tolerance, remove_duplicate_primitives,
                                                   remove_unreferenced_points, tf::return_index_map);
      },
      arg("indices"), arg("points"), arg("tolerance").none() = nanobind::none(),
      arg("remove_duplicate_primitives") = true,
  ...
  m.def(
      ...
      [](const offset_blocked_array_wrapper<int, int> &indices,
         ...
         bool remove_duplicate_primitives,
         bool remove_unreferenced_points) {
        return cleaned_impl_dynamic<int, double, 2>(indices, points, tolerance, remove_duplicate_primitives,
                                                    remove_unreferenced_points, tf::return_index_map);
      },
      arg("indices"), arg("points"), arg("tolerance").none() = nanobind::none(),
      arg("remove_duplicate_primitives") = true,
  ...
  m.def(
      ...
      [](const offset_blocked_array_wrapper<int64_t, int64_t> &indices,
         ...
         bool remove_duplicate_primitives,
         bool remove_unreferenced_points) {
        return cleaned_impl_dynamic<int64_t, float, 2>(indices, points, tolerance, remove_duplicate_primitives,
                                                       remove_unreferenced_points, tf::return_index_map);
      },
      arg("indices"), arg("points"), arg("tolerance").none() = nanobind::none(),
      arg("remove_duplicate_primitives") = true,
  ...
  m.def(
      ...
      [](const offset_blocked_array_wrapper<int64_t, int64_t> &indices,
         ...
         bool remove_duplicate_primitives,
         bool remove_unreferenced_points) {
        return cleaned_impl_dynamic<int64_t, double, 2>(indices, points, tolerance, remove_duplicate_primitives,
                                                        remove_unreferenced_points, tf::return_index_map);
      },
      arg("indices"), arg("points"), arg("tolerance").none() = nanobind::none(),
      arg("remove_duplicate_primitives") = true,
  ...
  m.def(
      ...
      [](const offset_blocked_array_wrapper<int, int> &indices,
         ...
         bool remove_duplicate_primitives,
         bool remove_unreferenced_points) {
        return cleaned_impl_dynamic<int, float, 3>(indices, points, tolerance, remove_duplicate_primitives,
                                                   remove_unreferenced_points, tf::return_index_map);
      },
      arg("indices"), arg("points"), arg("tolerance").none() = nanobind::none(),
      arg("remove_duplicate_primitives") = true,
  ...
  m.def(
      ...
      [](const offset_blocked_array_wrapper<int, int> &indices,
         ...
         bool remove_duplicate_primitives,
         bool remove_unreferenced_points) {
        return cleaned_impl_dynamic<int, double, 3>(indices, points, tolerance, remove_duplicate_primitives,
                                                    remove_unreferenced_points, tf::return_index_map);
      },
      arg("indices"), arg("points"), arg("tolerance").none() = nanobind::none(),
      arg("remove_duplicate_primitives") = true,
  ...
  m.def(
      ...
      [](const offset_blocked_array_wrapper<int64_t, int64_t> &indices,
         ...
         bool remove_duplicate_primitives,
         bool remove_unreferenced_points) {
        return cleaned_impl_dynamic<int64_t, float, 3>(indices, points, tolerance, remove_duplicate_primitives,
                                                       remove_unreferenced_points, tf::return_index_map);
      },
      arg("indices"), arg("points"), arg("tolerance").none() = nanobind::none(),
      arg("remove_duplicate_primitives") = true,
  ...
  m.def(
      ...
      [](const offset_blocked_array_wrapper<int64_t, int64_t> &indices,
         ...
         bool remove_duplicate_primitives,
         bool remove_unreferenced_points) {
        return cleaned_impl_dynamic<int64_t, double, 3>(indices, points, tolerance, remove_duplicate_primitives,
                                                        remove_unreferenced_points, tf::return_index_map);
      },
      arg("indices"), arg("points"), arg("tolerance").none() = nanobind::none(),
      arg("remove_duplicate_primitives") = true,
