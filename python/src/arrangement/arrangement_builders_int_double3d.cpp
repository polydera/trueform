...
* Author: Žiga Sajovic
*/
// The compiled build tier of the single-operand entries for int32,
...
namespace tf::py {
namespace {
using tri = form_t<int, double, 3, 3>;
using dyn = form_t<int, double, tf::dynamic_size, 3>;
using tri_forms = forms_range_t<int, double, 3, 3>;
using dyn_forms = forms_range_t<int, double, tf::dynamic_size, 3>;
} // namespace
