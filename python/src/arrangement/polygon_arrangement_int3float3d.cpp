...
auto register_polygon_arrangement_int3float3d(nanobind::module_ &m) -> void {
  m.def("polygon_arrangements_int3float3d",
        [](mesh_wrapper<int, float, 3, 3> &mesh, int mode, double tolerance, int triangulation) {
  ...
  m.def("polygon_arrangements_intdynfloat3d",
        [](mesh_wrapper<int, float, dynamic_size, 3> &mesh, int mode, double tolerance, int triangulation) {
          return polygon_arrangements(mesh, mode, tolerance, triangulation);
        },
        nanobind::arg("mesh"), nanobind::arg("mode"), nanobind::arg("tolerance") = 0.0, nanobind::arg("triangulation") = 0);
