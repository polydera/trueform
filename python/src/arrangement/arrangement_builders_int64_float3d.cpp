...
// float32, 3D: the self arrangement and the N-operand arrangement.
...
namespace tf::py {
namespace {
using tri = form_t<std::int64_t, float, 3, 3>;
using dyn = form_t<std::int64_t, float, tf::dynamic_size, 3>;
