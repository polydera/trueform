...
Default: `mode="primitives"`, `tolerance=0.0` (exact), `resolve_crossings` auto (`True` for 3+ meshes, `False` for 2), `resolve_self_crossings=False`. See [Intersection Configuration](/py/modules/intersect#intersection-configuration).
