...
For implementation details and additional topology operations like hole patching and path finding, see the [C++ Topology](/cpp/modules/topology) documentation.
::
