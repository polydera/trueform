...
Options: `ignore_open_fragments=True` masks open fragments (surface pieces carrying boundary edges) out of the region formation instead of letting them partition. Default `False`.
