...
To learn more about exact predicates and canonical topology, see [Intersect](/py/modules/intersect#intersection-modes), [Cut](/py/modules/cut#supported-input), and [Research](/cpp/about/research).
::
