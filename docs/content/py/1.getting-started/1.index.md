...
`trueform` is a Python library for real-time geometric processing, built on the principles of composable views and inline policy injection. It operates directly on your *plain-old-data*, by providing semantic views that wrap it with geometric meaning.
...
<!-- TODO: add getting started, tutorial, benchmarks, and examples, then uncomment -->
<!-- 
::card-group
  :::card
  ---
  ...
  ---
  Requirements and installation via PyPI.
  :::
...
<!-- This is trueform from a bird's eye view. For comprehensive coverage of all features, patterns, and advanced usage, explore the module documentation starting with [Core](/py/modules/core). -->
