---
title: Introduction
description: Native geometry processing for the web. Fast and exact mesh booleans, spatial queries, arrangements, registration, and remeshing.
navigation:
  icon: i-lucide-house
---

`trueform` is a TypeScript geometry processing library. Fast and exact mesh booleans, spatial queries, arrangements, registration, and remeshing — at native speed in the browser and Node.js. WASM-backed NDArrays, sync and async. Exact and robust on million-polygon meshes.
...
const simplified = tf.simplified(mesh, { errorRel: 0.005 });
