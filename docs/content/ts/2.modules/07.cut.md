...
- **Crossing intersection curves** — where curves from different mesh pairs meet on a face, crossings can be resolved. Controlled via `IntersectOpts` — see [Intersection Modes](/ts/modules/intersect#intersection-modes).
