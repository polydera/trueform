...
See [Geometry](/ts/modules/geometry#normals), [Topology](/ts/modules/topology#adjacency-structures), and [Spatial](/ts/modules/spatial) for full async precompute APIs.
