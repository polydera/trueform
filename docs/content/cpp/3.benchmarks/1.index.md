...
|-----------|-------|------|---------|----------|----------|
| Boolean Union | 2 × 1M | 27 ms | **61×** | CGAL `Simple_cartesian<double>` | reduction diagrams, double |
| Mesh–Mesh Curves | 2 × 1M | 5.5 ms | **156×** | CGAL `Simple_cartesian<double>` | reduction diagrams, double |
| Self-Intersection | 2 × 1M | 112 ms | **46×** | libigl EPECK (GMP/MPFR) | reduction diagrams, double |
