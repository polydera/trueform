...
To learn more about exact predicates and canonical topology, see [Intersect](/cpp/modules/intersect#intersection-modes), [Cut](/cpp/modules/cut#supported-input), and [Research](/cpp/about/research).
::
...
::card-group
  ...
  to: /cpp/benchmarks/remesh
  ---
  Quadric error decimation and isotropic remeshing.
  ::
