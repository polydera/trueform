...
tf::face_membership<int> fm(polygons);
tf::manifold_edge_link<int, 3> mel(polygons.faces(), fm);
tf::aabb_tree<int, float, 3> tree(polygons, tf::config_tree(4, 4));

auto form0 = tf::make_form(tree, polygons | tf::tag(mel) | tf::tag(fm));

// Apply transformation lazily—no data copy
tf::frame<float, 3> frame = tf::make_frame(rotation);
auto form1 = tf::make_form(frame, tree, polygons | tf::tag(mel) | tf::tag(fm));

auto result = tf::make_boolean(form0, form1, tf::boolean_op::merge);
```

The benchmarks also compare boundary path extraction, polygon tree construction, closest point queries, and mesh-mesh intersection curves. Sources: [topology](https://github.com/xlabmedical/trueform/tree/main/benchmarks/topology), [spatial](https://github.com/xlabmedical/trueform/tree/main/benchmarks/spatial), [cut](https://github.com/xlabmedical/trueform/tree/main/benchmarks/cut), [intersect](https://github.com/xlabmedical/trueform/tree/main/benchmarks/intersect).
...
The benchmarks also compare tree construction times. Sources: [spatial](https://github.com/xlabmedical/trueform/tree/main/benchmarks/spatial).
...
The benchmarks also compare boundary path extraction, isocontour generation, boolean operations, and self-intersection detection. Sources: [topology](https://github.com/xlabmedical/trueform/tree/main/benchmarks/topology), [intersect](https://github.com/xlabmedical/trueform/tree/main/benchmarks/intersect), [cut](https://github.com/xlabmedical/trueform/tree/main/benchmarks/cut).
...
The benchmarks compare connected components, boundary paths, isocontours, mesh-mesh intersection curves, and embedded isocurves. Sources: [topology](https://github.com/xlabmedical/trueform/tree/main/benchmarks/topology), [intersect](https://github.com/xlabmedical/trueform/tree/main/benchmarks/intersect), [cut](https://github.com/xlabmedical/trueform/tree/main/benchmarks/cut).
