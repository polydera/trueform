---
title: Introduction
description: The STL for Geometry. Fast and exact mesh booleans, spatial queries, arrangements, registration, and remeshing.
navigation:
  icon: i-lucide-house
---

`trueform` is a header-only C++ geometry processing library. Fast and exact mesh booleans, spatial queries, topology, remeshing — composable algorithms that operate directly on your data with zero-copy views. Build a spatial tree once, tag it, reuse it everywhere. Exact and robust on million-polygon meshes.
