...
This is trueform from a bird's eye view. For comprehensive coverage of all features, patterns, and advanced usage, explore the [module documentation](/cpp/modules).
