...
Pipeline spans cut, topology, and reindex: [`triangulated`](/cpp/modules/geometry#triangulated) + [`cleaned`](/cpp/modules/clean#cleaned) per input, then [`make_mesh_arrangements`](/cpp/modules/cut#make_mesh_arrangements), [`cleaned`](/cpp/modules/clean#cleaned), [`make_domain_labels`](/cpp/modules/topology#make_domain_labels), and [`split_into_domains`](/cpp/modules/reindex#split_into_domains). Non-manifold edges are rendered via [`make_tube_mesh`](/cpp/modules/geometry#make_tube_mesh).
