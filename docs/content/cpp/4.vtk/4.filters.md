...
Computes normals and optionally orients faces consistently. Wraps [`orient_faces_consistently`](/cpp/vtk/functions#orient_faces_consistently), [`compute_cell_normals`](/cpp/vtk/functions#compute_cell_normals), and [`compute_point_normals`](/cpp/vtk/functions#compute_point_normals).
