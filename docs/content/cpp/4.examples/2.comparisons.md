...
These examples provide direct performance comparisons with established geometry processing libraries, demonstrating the efficiency of trueform's data structures and algorithms. Detailed benchmark results and performance analysis are available at [/benchmarks](/cpp/benchmarks).
...
**Performance:** 1.8-2.0x speedup for k-NN queries. See [benchmarks](/cpp/benchmarks#spatial-trees-and-queries) for detailed results.
::
...
::callout{icon="i-lucide-trending-up" color="blue"}
**Performance:** 8-12x speedup over CGAL. See [benchmarks](/cpp/benchmarks#spatial-trees-and-queries) for detailed results.
::
...
::callout{icon="i-lucide-trending-up" color="blue"}
**Performance:** 30x+ speedup over CGAL for mesh-mesh intersection curves. See [benchmarks](/cpp/benchmarks#intersection-curves) for detailed scaling characteristics.
::
...
::callout{icon="i-lucide-trending-up" color="blue"}
**Performance:** 2273x speedup at 40k edges. CGAL exhibits superlinear complexity growth while trueform maintains near-linear scaling. See [benchmarks](/cpp/benchmarks#planar-arrangements) for detailed analysis.
::
...
::callout{icon="i-lucide-trending-up" color="blue"}
**Performance:** 30-80x speedup over CGAL depending on mesh size. See [benchmarks](/cpp/benchmarks#mesh-booleans) for detailed results.
::
...
::callout{icon="i-lucide-trending-up" color="blue"}
**Performance:** 10-30x speedup for boundary and non-manifold edge detection. See [benchmarks](/cpp/benchmarks#feature-edges) for detailed results.
::
...
::callout{icon="i-lucide-trending-up" color="blue"}
**Performance:** 100x+ speedup over VTK for mesh-mesh intersection curves, with superlinear scaling advantage at larger problem sizes. See [benchmarks](/cpp/benchmarks#intersection-curves) for detailed results.
::
