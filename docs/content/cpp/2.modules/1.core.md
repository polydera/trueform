...
::note
For comprehensive reindexing operations including filtering by mask/ids and maintaining referential integrity, see the [Reindex module](/cpp/modules/reindex).
::
