...
// Returns tf::polygons_buffer<Index, RealType, 3, 3>
auto sphere = tf::make_sphere_mesh<int, float>(20, 20, 1.0f);

// Access the mesh data
for (auto polygon : sphere.polygons()) {
    // Each polygon is a triangle with outward-facing normals
}
```
...
// Returns tf::polygons_buffer<Index, RealType, 3, 3>
auto cylinder = tf::make_cylinder_mesh<int, float>(20, 1.0f, 2.0f);

// Cylinder extends from z = -height/2 to z = +height/2
