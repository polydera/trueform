...
- **Crossing intersection curves** — where two or more curves meet at a point, crossings can be resolved by splitting curves at the crossing point. This is controlled via `tf::intersect_mode` flags — see [Intersection Modes](#intersection-modes).
