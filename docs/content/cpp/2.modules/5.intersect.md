...
auto form1 = mesh1.polygons() | tf::tag(mel1) | tf::tag(fm1) | tf::tag(tree1);
auto form2 = mesh2.polygons() | tf::tag(mel2) | tf::tag(fm2) | tf::tag(tree2);
...
auto form = mesh.polygons() | tf::tag(mel) | tf::tag(fm) | tf::tag(tree);
