...
```cpp
// Include everything from a module
#include <trueform/spatial.hpp>

// Or just what you need
#include <trueform/spatial/aabb_tree.hpp>
#include <trueform/spatial/make_form.hpp>
```

Aggregation headers list everything a module offers. For example, `include/trueform/spatial.hpp` includes all spatial functionality—read it to see what's available.
