...
import data from "../../../benchmarks/boundary_paths.json";
...
const color = (_: any, i: number) => ["#00d5be", "#fdff4e", "#ff6b6b", "#00529b"][i];
...
const maxY = Math.max(...data.flatMap((d: any) => [d.tf, d.cgal, d.igl, d.vtk]));
