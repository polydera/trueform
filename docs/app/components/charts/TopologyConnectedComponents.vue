...
import data from "../../../benchmarks/connected_components.json";
...
const color = (_: any, i: number) => ["#00d5be", "#00529b", "#fdff4e", "#ff6b6b"][i];
...
const maxY = Math.max(...data.flatMap((d: any) => [d.tf, d.vtk, d.cgal, d.igl]));
