    ...
    <div class="diagram-box">
      <svg viewBox="0 0 540 940" class="w-full">
        ...
        <text x="278" y="143" class="step-label">
          <tspan class="syn-ns">tf</tspan><tspan>::</tspan><tspan class="syn-fn">make_mesh_arrangements</tspan>
        </text>
        ...
        <!-- Arrow 2 -->
        <path d="M 270 263 L 270 316" class="arrow-line" marker-end="url(#ap-arrow)" />
        <text x="278" y="296" class="step-label">
          ...
          <tspan class="syn-ns">tf</tspan><tspan>::</tspan><tspan class="syn-fn">reindexed</tspan>
        </text>
        ...
        <g transform="translate(270, 348)">
          ...
          <text x="-225" y="42" class="code-tiny">
            <tspan class="syn-var">tag_labels</tspan><tspan opacity="0.55"> aligned to surviving faces via </tspan><tspan class="syn-var">face_im</tspan>
          </text>
        </g>

        <!-- Arrow 3 -->
        <path d="M 270 416 L 270 469" class="arrow-line" marker-end="url(#ap-arrow)" />
        <text x="278" y="449" class="step-label">
          <tspan class="syn-ns">tf</tspan><tspan>::</tspan><tspan class="syn-fn">make_domain_labels</tspan>
        </text>
        ...
        <g transform="translate(270, 501)">
          ...
          <text x="-225" y="22" class="code-tiny">
            <tspan class="syn-var">labels</tspan><tspan>[</tspan><tspan class="syn-var">f</tspan><tspan>][</tspan><tspan class="syn-num">0</tspan><tspan>]</tspan>
            <tspan opacity="0.55"> — domain containing f with </tspan>
            <tspan class="syn-type">reversed winding</tspan>
          </text>
          <text x="-225" y="42" class="code-tiny">
            <tspan class="syn-var">labels</tspan><tspan>[</tspan><tspan class="syn-var">f</tspan><tspan>][</tspan><tspan class="syn-num">1</tspan><tspan>]</tspan>
            <tspan opacity="0.55"> — domain containing f with </tspan>
          ...
          <text x="-225" y="82" class="code-tiny" opacity="0.55">
            flags: <tspan class="syn-var">ignore_open_fragments</tspan>, <tspan class="syn-var">exclude_outer_shell</tspan>
          </text>
        </g>

        <!-- Arrow 4 -->
        <path d="M 270 607 L 270 660" class="arrow-line" marker-end="url(#ap-arrow)" />
        ...
        <!-- Arrow 5 -->
        <path d="M 270 778 L 270 831" class="arrow-line" marker-end="url(#ap-arrow)" />
        <text x="278" y="811" class="step-label">
          read <tspan class="syn-var">labels</tspan><tspan>[</tspan><tspan class="syn-var">f</tspan><tspan>][</tspan><tspan class="syn-num">0</tspan><tspan>] / [</tspan><tspan class="syn-num">1</tspan><tspan>]</tspan> for knife faces
        </text>
