...
if(NOT EXISTS "${LINK_MAP}")
  message(FATAL_ERROR "float/int64/2D mesh-measurements link map does not exist: ${LINK_MAP}")
endif()

file(READ "${LINK_MAP}" link_map)

set(expected_object "mesh_measurements_float_int64_2d.cpp.o")
...
foreach(unrelated_object IN ITEMS
    ...
    mesh_measurements_double_int64_3d.cpp.o)
  string(FIND "${link_map}" "${unrelated_object}" unrelated_position)
  if(NOT unrelated_position EQUAL -1)
    message(FATAL_ERROR
      "float/int64/2D mesh-measurements link extracted unrelated object: ${unrelated_object}")
  endif()
endforeach()

message(STATUS
  "Float/int64/2D mesh-measurements link extracted only its requested production shard")
