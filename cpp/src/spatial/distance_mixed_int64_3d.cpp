...
using mesh_float_int32_t = mesh<std::int32_t, float, 3, Ngon>;
template <std::size_t Ngon>
using mesh_double_int32_t = mesh<std::int32_t, double, 3, Ngon>;
#endif
template <std::size_t Ngon>
using mesh_float_int64_t = mesh<std::int64_t, float, 3, Ngon>;
template <std::size_t Ngon>
using mesh_double_int64_t = mesh<std::int64_t, double, 3, Ngon>;
using point_cloud_float = point_cloud<float, 3>;
using point_cloud_double = point_cloud<double, 3>;
