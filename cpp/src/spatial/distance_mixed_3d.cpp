...
template auto distance2(const point_cloud<float, 3> &,
                        const point_cloud<double, 3> &) -> double;
template auto distance2(const point_cloud<double, 3> &,
                        const point_cloud<float, 3> &) -> double;
template auto distance(const point_cloud<float, 3> &,
                       const point_cloud<double, 3> &) -> double;
template auto distance(const point_cloud<double, 3> &,
                       const point_cloud<float, 3> &) -> double;
