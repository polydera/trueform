...
using intersects_float_mesh_t = mesh<Index, float, 3, Ngon>;
template <typename Index>
using intersects_float_edge_t = edge_mesh<Index, float, 3>;
template <typename Index, std::size_t Ngon>
using intersects_double_mesh_t = mesh<Index, double, 3, Ngon>;
template <typename Index>
using intersects_double_edge_t = edge_mesh<Index, double, 3>;
/// A point cloud names no index of its own.
using intersects_float_cloud_t = point_cloud<float, 3>;
using intersects_double_cloud_t = point_cloud<double, 3>;
/// A query, named by its real alone.
template <typename QueryReal>
using intersects_query_t = primitive<QueryReal, 3>;
