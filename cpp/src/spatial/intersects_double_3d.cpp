...
using intersects_mesh_t = mesh<Index, double, 3, Ngon>;
template <typename Index> using intersects_edge_t = edge_mesh<Index, double, 3>;
/// A point cloud names no index of its own.
using intersects_cloud_t = point_cloud<double, 3>;
