...
using intersects_mesh_t = mesh<Index, float, 2, Ngon>;
template <typename Index> using intersects_edge_t = edge_mesh<Index, float, 2>;
/// A point cloud names no index of its own.
using intersects_cloud_t = point_cloud<float, 2>;
