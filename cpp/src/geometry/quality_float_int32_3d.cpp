...
#define TF_CPP_INSTANTIATE_MESH_QUALITY(Ngon)                                  \
  template auto face_quality<std::int32_t, float, 3, Ngon>(                    \
      const mesh<std::int32_t, float, 3, Ngon> &)                              \
      -> face_quality_result<float>;                                           \
  template auto dihedral_angles<std::int32_t, float, 3, Ngon>(                 \
      const mesh<std::int32_t, float, 3, Ngon> &)                              \
      -> dihedral_angles_result<std::int32_t, float>
