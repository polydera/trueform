...
// The compiled build tier for float coordinates, int32 and int64 indices.
...
namespace {
template <std::size_t Ngon> using a = form_t<std::int32_t, float, Ngon>;
template <std::size_t Ngon> using b = form_t<std::int64_t, float, Ngon>;
} // namespace
