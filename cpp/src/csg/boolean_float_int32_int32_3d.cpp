...
#define TF_CPP_INSTANTIATE_BOOLEAN(Ngon0, Ngon1)                               \
  template auto make_boolean<std::int32_t, float, std::int32_t, Ngon0, Ngon1>( \
      ...
      -> boolean_result<common_index_t<std::int32_t, std::int32_t>, float, \
                            detail::concatenated_arity_v<Ngon0, Ngon1>>;       \
  template auto                                                                \
  make_boolean_with_curves<std::int32_t, float, std::int32_t, Ngon0, Ngon1>(   \
      const mesh<std::int32_t, float, 3, Ngon0> &,                             \
      const mesh<std::int32_t, float, 3, Ngon1> &, tf::boolean_op,             \
      std::vector<std::int32_t>, tf::arrangement_config)                       \
      -> boolean_with_curves_result<                                       \
          common_index_t<std::int32_t, std::int32_t>, float,                   \
          detail::concatenated_arity_v<Ngon0, Ngon1>>
