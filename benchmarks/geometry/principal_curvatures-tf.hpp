/**
 * Principal curvatures benchmark with TrueForm
 *
 * Measures time to compute principal curvatures for triangle meshes
 * using TrueForm's compute_principal_curvatures.
 *
...
/**
 * Run TrueForm principal curvatures benchmark
 *
