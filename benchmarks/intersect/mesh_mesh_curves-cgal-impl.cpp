/**
 * Mesh-mesh intersection curves benchmark with CGAL - Implementation
 *
...
int run_mesh_mesh_curves_cgal_benchmark(
  ...
  for (const auto &path : mesh_paths) {
    ...
    auto time_ms = benchmark::mean_time_of(
        ...
        [&]() {
          std::vector<std::vector<Point_3_d>> polylines;
          PMP::surface_intersection(mesh1, mesh2,
