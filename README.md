...
- **Intersections collapse to canonical form.** The reduction diagram maps intersections to their unique representative in the ε-topology, ensuring consistency under floating-point uncertainty.

- **Artifacts are modeled as independent noise.** Locally across polygon regions and globally across manifold edge-connected components—allowing correct classification of the intended structure.
